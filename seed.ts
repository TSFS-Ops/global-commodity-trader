...
// DISABLED: Phantom data seeding function removed to ensure authentic data only
export async function seedMockOrders_DISABLED() {
  try {
...
export async function seedAllData() {
  ...
  // DISABLED: await seedMockOrders(); // Removed to prevent phantom data
}